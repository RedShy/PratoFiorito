...
public class UserDAO {
	...
	public void init() {
		/*
		User u1= new User();
		u1.setUsername("ciccio");
		u1.setPassword("ciccio");
		save(u1);
		User u2= new User();
		u2.setUsername("franco");
		u2.setPassword("franco");
		save(u1);
		*/
	}
	...
	public boolean exists(User user) {
		...
		Query<User> query = openSession.createQuery("from User as us where us.username=:u and us.password=:p", User.class)
